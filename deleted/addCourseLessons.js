$(function(){
    ...
    $('.addNewLesson').click(()=>{
        ...
        newLesson += '<label id="videosPath" class="btn btn-primary" for="choose-lesson'+ lessonNumber + ' lesson-vids-to-add">Choose Videos</label>';
        newLesson += '<input id="choose-lesson'+ lessonNumber + ' lesson-vids-to-add" class="lesson-vids form-control" type="file" name="course-videos" accept="video/mp4,video/x-m4v,video/*" multiple>'
